...
const stages: Stage[] = [
  ...
  },
  {
    ...
    title: "Prototype",
    events: [
      { label: "To-be redesigned", meta: "New flow defined" },
      { label: "Tool prototyped", meta: "Build shipped" },
      { label: "Output validated", meta: "Logic checked" },
    ],
  },
  {
    number: "05",
    ...
    events: [
      ...
      { label: "User trained", meta: "UAT passed" },
